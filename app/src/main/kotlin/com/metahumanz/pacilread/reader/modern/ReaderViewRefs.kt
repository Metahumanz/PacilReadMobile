...
class ReaderViewRefs private constructor(activity: Activity) {
    ...
    @JvmField val quickTtsToggleButton: Button = activity.findViewById(R.id.button_quick_tts_toggle)
    @JvmField val quickTtsStopButton: Button = activity.findViewById(R.id.button_quick_tts_stop)
    @JvmField val quickActionsPanel: View = activity.findViewById(R.id.reader_quick_actions)
