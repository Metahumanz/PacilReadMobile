...
public final class ReaderChromeController {
    ...
    public void updateSystemBarsVisibility(boolean showSystemBars) {
        if (state.deferSystemBarsForTransition) {
            state.deferredSystemBarsVisible = showSystemBars;
            return;
        }
        Window window = activity.getWindow();
    ...
    public void setSystemBarsTransitionDeferred(boolean deferred) {
        state.deferSystemBarsForTransition = deferred;
        if (!deferred) {
            updateSystemBarsVisibility(state.deferredSystemBarsVisible);
        }
    }
