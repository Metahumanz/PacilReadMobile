...
public final class ReaderViewRefs {
    ...
    public final TextView pageTitleCurrentRight;
    public final JustifiedPageTextView pageBodyCurrentRight;
    public final TextView pageTitleIncoming;
    public final JustifiedPageTextView pageBodyIncoming;
    public final TextView pageTitleIncomingRight;
    public final JustifiedPageTextView pageBodyIncomingRight;
    ...
    private ReaderViewRefs(Activity activity) {
        ...
        pageTitleCurrentRight = activity.findViewById(R.id.text_page_title_current_right);
        pageBodyCurrentRight = activity.findViewById(R.id.text_page_body_current_right);
        ...
        pageTitleIncomingRight = activity.findViewById(R.id.text_page_title_incoming_right);
        pageBodyIncomingRight = activity.findViewById(R.id.text_page_body_incoming_right);
