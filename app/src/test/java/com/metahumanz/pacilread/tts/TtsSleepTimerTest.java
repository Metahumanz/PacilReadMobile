...
public class TtsSleepTimerTest {
    @Test
    public void convertsSliderInFiveMinuteSteps() {
    ...
    @Test
    public void convertsPreciseHoursMinutesAndSeconds() {
        long value = TtsSleepTimer.preciseToMillis(2, 3, 4);
        assertEquals(7_384_000L, value);
        assertArrayEquals(new int[]{2, 3, 4}, TtsSleepTimer.millisToPrecise(value));
    }

    @Test
    public void deadlineKeepsCountingWhilePlaybackIsPaused() {
        long deadline = TtsSleepTimer.deadlineFrom(1_000L, 5_000L);
